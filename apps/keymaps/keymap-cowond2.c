...
static const struct button_mapping button_context_standard[]  = {
    ...
    { ACTION_STD_TOGGLEBACKLIGHT,BUTTON_POWER,            BUTTON_POWER },
...
static const struct button_mapping button_context_wps[]  = {
    ...
    { ACTION_WPS_TOGGLEBACKLIGHT,BUTTON_POWER|BUTTON_REL,        BUTTON_POWER },

#ifdef HAVE_BUTTONS_IN_HOLD_MODE
    /* Make the player more usable whilst in your pocket, with the hold switch on */
    { ACTION_WPS_VOLDOWN,        BUTTON_HOLDMINUS|BUTTON_REPEAT,BUTTON_NONE },
    { ACTION_WPS_VOLUP,          BUTTON_HOLDPLUS|BUTTON_REPEAT, BUTTON_NONE },
...
static const struct button_mapping button_context_list[]  = {
   ...
   /* Make the player more usable whilst in your pocket, with the hold switch on */
    ...
    { ACTION_LIST_VOLDOWN,  BUTTON_HOLDMINUS|BUTTON_REPEAT,BUTTON_NONE },
    { ACTION_LIST_VOLUP,    BUTTON_HOLDPLUS|BUTTON_REPEAT, BUTTON_NONE },
#endif
